<div class="content">
    <nav class="navbar navbar-expand-md navbar-dark colorBackground">
        <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
            ...
            @else
            <li class="nav-item">
                    <a class="nav-link" href="{{ action('PreguntasControlador@index') }}">Volver al inicio</a>
                </li>
            @endif
            </ul>
        </div>
        <div class="mx-auto order-0 logo_redim">
            <a href="{{ action('PreguntasControlador@index') }}"><img src="https://i.ibb.co/GQjFrd9/logo.png" alt="logo"></a>
        </div>
